<template>
    <div class="c-progress" style="width: 100px;">
...
export default {
    ...
    mounted () {
        this.sliderLeft = this.width / 10* this.percent;
    ...
    methods: {
        ...
        // 算出百分比
        _countCurPercent () {
            this.tempPercent = Math.ceil(parseInt(this.sliderLeft / this.width * 10));
